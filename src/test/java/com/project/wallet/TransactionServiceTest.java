...
//    }
    ...
    public void getTransactionByIdtest()
    {
        ...
        System.out.println(transactionService.getById(75));
        Assertions.assertThat(transactionService.getById(75)).isEqualTo(transaction);
    }
    @Test
    public void getAllTransactionTest()
    {
        ...
        Assertions.assertThat(transactionService.findTransaction()).isEqualTo(transactionList);
